...
agent_communication:
  ...
  - agent: "main"
    message: "🚀 DÉMARRAGE SIPORTS v2.0 - CHATBOT IA GRATUIT: Implémentation d'un chatbot IA gratuit utilisant Ollama avec des modèles locaux (TinyLlama, Gemma2) pour assistance événements maritimes, recommandations exposants, suggestions forfaits. Pas de clés API externes nécessaires."
