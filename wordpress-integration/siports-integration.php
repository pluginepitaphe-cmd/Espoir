...
class SiportsIntegration {
    ...
    public function __construct() {
        ...
        $this->api_url = get_option('siports_api_url', 'https://siports-maritime-1.preview.emergentagent.com/api');
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="url" name="siports_api_url" value="<?php echo esc_attr(get_option('siports_api_url', 'https://siports-maritime-1.preview.emergentagent.com/api')); ?>" class="regular-text" />
...
register_activation_hook(__FILE__, function() {
    ...
    add_option('siports_api_url', 'https://siports-maritime-1.preview.emergentagent.com/api');
