...
class WordPressConfig(BaseSettings):
    ...
    siports_api_url: str = os.getenv("SIPORTS_API_URL", "https://4efe408b-c94a-400d-a866-c80c08ec5c16.preview.emergentagent.com")
    
    # Configuration CORS
    cors_origins: List[str] = [
        "https://siportevent.com",
        "https://www.siportevent.com",
        "https://4efe408b-c94a-400d-a866-c80c08ec5c16.preview.emergentagent.com",
        "http://localhost:3000",
        "http://localhost:8000",
        "http://127.0.0.1:3000"
    ]
