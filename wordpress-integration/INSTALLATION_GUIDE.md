...
2. Configurez :
   - **URL API SIPORTS** : `https://ec48b228-5fe8-445c-98da-33775eea8a9d.preview.emergentagent.com/api`
...
curl -X GET "https://ec48b228-5fe8-445c-98da-33775eea8a9d.preview.emergentagent.com/api/sync/status"
```
